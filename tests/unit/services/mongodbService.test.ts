...
describe('mongodbService', () => {
  ...
  describe('saveDataToDatabase', () => {
    it('should save data to database and update last update date', async () => {
      await MongodbService.saveDataToDatabase(mockData, mockCollectionName, mockPlatform, mockUpdateType);
    ...
    it('should handle errors correctly', async () => {
      ...
      await expect(MongodbService.saveDataToDatabase(mockData, mockCollectionName, mockPlatform, mockUpdateType))
