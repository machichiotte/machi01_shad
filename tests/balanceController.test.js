...
test('updateBalance should call expected functions and return mapped data', async () => {
    // Mock dependencies
...
test('updateBalance should handle error if fetchBalance fails', async () => {
...
test('updateBalance should handle error if mapBalance fails', async () => {
...
test('updateBalance should call deleteAndSaveData with correct parameters on success', async () => {
...
test('updateBalance should call saveLastUpdateToMongoDB with correct parameters on success', async () => {
    // Mock dependencies to simulate successful update
    const mockExchange = { fetchBalance: jest.fn().mockResolvedValue({ mockData: 'data' }) };
    createExchangeInstance.mockReturnValue(mockExchange);
    mapBalance.mockReturnValue({ mockMappedData: 'mappedData' });
