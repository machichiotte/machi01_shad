...
const stableCoins: string[] = [
    "USDT", "USDC", "DAI", "FDUSD", "USDD", "TUSD", "FRAX",
    "PYUSD", "USDJ", "USDP", "GUSD", "LUSD"
];
 ...
 */
function getTotalUSDT(symbol: string, cost: number, conversionRates: Record<string, number> = {}): number | null {
