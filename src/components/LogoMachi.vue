      ...
      >
        <g id="tight-bounds" transform="matrix(1,0,0,1,0.2399966921794885,0.015418891531538748)">
          <svg viewBox="0 0 395.52 140.96916221693695" height="140.96916221693695" width="395.52">
            <g>
              <svg
                viewBox="0 0 395.52 140.96916221693695"
                height="140.96916221693695"
                width="395.52"
              >
                <g transform="matrix(1,0,0,1,0,87.12459765237239)">
                  <svg
                    viewBox="0 0 395.52 53.844564564564564"
                    height="53.844564564564564"
                    width="395.52"
                  >
                        ...
                        <g>
                          ...
                          >
                            <g transform="matrix(1,0,0,1,0,0)">
                              <svg
                                width="395.52"
                                viewBox="2.450000047683716 -33.5 249.72999572753906 34"
                                height="53.844564564564564"
                                data-palette-color="#034f74"
                              >
                                <path
                ...
                <g transform="matrix(1,0,0,1,160.9701860802841,0)">
                  <svg
                    viewBox="0 0 73.5796278394318 74.41318822822824"
                    height="74.41318822822824"
                ...
                <g>
                  <rect
                    width="160.9701860802841"
                    height="4.855758400023063"
                    y="68.55742982820517"
                    x="234.5498139197159"
                    :fill="color"
                    data-fill-palette-color="accent"
