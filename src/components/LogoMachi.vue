              ...
              <svg viewBox="0 0 395.52 140.96916221693695" height="140.96916221693695" width="395.52">
                            ...
                            <g transform="matrix(1,0,0,1,0,0)">
                              <svg width="395.52" viewBox="2.450000047683716 -33.5 249.72999572753906 34"
                                ...
                                <path
                                  ...
                                  opacity="1" transform="matrix(1,0,0,1,0,0)" :fill="color" class="wordmark-text-0"
                      ...
                      <svg version="1.1" x="7.9999999999999964" y="0"
                        ...
                        <g :fill="color" data-fill-palette-color="accent">
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            :fill="color" data-fill-palette-color="accent"></polygon>
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            :fill="color" data-fill-palette-color="accent"></polygon>
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                            points="65.711,62.394 80.552,57.663 82.061,45.131 66.162,47.226  " :fill="color"
                ...
                <g>
                  <rect width="160.9701860802841" height="4.855758400023063" y="68.55742982820517" x="234.5498139197159"
                    :fill="color" data-fill-palette-color="accent"></rect>
                  <rect width="160.9701860802841" height="4.855758400023063" y="68.55742982820517" x="0" :fill="color"
                    data-fill-palette-color="accent"></rect>
                  <rect width="160.9701860802841" height="4.855758400023063" y="58.845913028159046"
                    x="234.5498139197159" :fill="color" data-fill-palette-color="accent"></rect>
                  <rect width="160.9701860802841" height="4.855758400023063" y="58.845913028159046" x="0" :fill="color"
                    data-fill-palette-color="accent"></rect>
                </g>
              </svg>
            </g>
