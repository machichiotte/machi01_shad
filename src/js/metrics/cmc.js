// src/js/metrics/cmc.js
import store from '@/store/store.js'
import { GET_CMC } from '@/store/storeconstants'

function getCmcValues(symbol) {
  const cmc = store.getters['calcul/' + GET_CMC]
...
function getIconUrl(id) {
  return `https://s2.coinmarketcap.com/static/img/coins/64x64/${parseInt(id)}.png`
}
