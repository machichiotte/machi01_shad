...
const shadColumns = [
  ...
  { header: 'Current Price', field: 'currentPrice', type: 'number' },
  { header: 'Wallet', field: 'currentPossession', type: 'number' },
  { header: 'Profit', field: 'profit', type: 'number' },
  { header: 'Total sell', field: 'totalSell', type: 'number' },
  { header: 'Recup shad', field: 'recupShad', type: 'number' } /*{
    label:'Open Orders',
    children: [*/,
