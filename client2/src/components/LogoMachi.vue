...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g transform="matrix(0.7,0,0,0.7,149.5757635564118,375.3727490229102)">
      <svg viewBox="0 0 396 141" data-background-color="#ffffff" preserveAspectRatio="xMidYMid meet" height="356"
            ...
            <g>
              <svg viewBox="0 0 395.52 140.96916221693695" height="140.96916221693695" width="395.52">
                        ...
                        <g>
                          <svg viewBox="0 0 395.52 53.844564564564564" height="53.844564564564564" width="395.52">
                            <g transform="matrix(1,0,0,1,0,0)">
                              <svg width="395.52" viewBox="2.450000047683716 -33.5 249.72999572753906 34"
                                height="53.844564564564564" data-palette-color="#034f74">
                                <path
                                  ...
                                  opacity="1" transform="matrix(1,0,0,1,0,0)" :fill=props.color class="wordmark-text-0"
                ...
                <g transform="matrix(1,0,0,1,160.9701860802841,0)">
                  <svg viewBox="0 0 73.5796278394318 74.41318822822824" height="74.41318822822824"
                    width="73.5796278394318">
                    <g>
                      <svg version="1.1" x="7.9999999999999964" y="0"
                        viewBox="12.982999801635742 1 75.68599700927734 97.81300354003906"
                        enable-background="new 0 0 100 100" xml:space="preserve" height="74.41318822822824"
                        width="57.5796278394318" class="icon-icon-0" data-fill-palette-color="accent" id="icon-0">
                        <g :fill=props.color data-fill-palette-color="accent">
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                            points="12.983,10.59 30.001,98.813 24.129,39.764 53.15,37.872 53.096,27.989    64.549,1 53.622,18.977  "
                            :fill=props.color data-fill-palette-color="accent"></polygon>
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            :fill=props.color data-fill-palette-color="accent"></polygon>
                          <polygon fill-rule="evenodd" clip-rule="evenodd"
                            points="65.711,62.394 80.552,57.663 82.061,45.131 66.162,47.226  " :fill=props.color
                ...
                <g>
                  <rect width="160.9701860802841" height="4.855758400023063" y="68.55742982820517" x="234.5498139197159"
                    :fill=props.color data-fill-palette-color="accent"></rect>
                  <rect width="160.9701860802841" height="4.855758400023063" y="68.55742982820517" x="0"
                    :fill=props.color data-fill-palette-color="accent"></rect>
                  <rect width="160.9701860802841" height="4.855758400023063" y="58.845913028159046"
                    x="234.5498139197159" :fill=props.color data-fill-palette-color="accent"></rect>
                  <rect width="160.9701860802841" height="4.855758400023063" y="58.845913028159046" x="0"
                    :fill=props.color data-fill-palette-color="accent"></rect>
                </g>
              </svg>
            </g>
